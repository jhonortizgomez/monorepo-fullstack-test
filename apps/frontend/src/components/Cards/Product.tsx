...
export const ProductCard = (props: Props) => {
  ...
  return (
    <div className="relative rounded-tr-3xl border border-gray-100 w-2xs flex flex-col justify-center">
      ...
      <div className="p-4 text-center">
        ...
        <button
          ...
          className="mt-4 block rounded-md border border-indigo-900 bg-indigo-900 px-5 py-3 text-sm font-medium uppercase tracking-widest text-white transition-colors hover:bg-white hover:text-indigo-900 mx-auto" 
        >
